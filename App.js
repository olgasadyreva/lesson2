const style1 = {'backgroundImage': 'url(images/1.svg)'};
const style2 = {'backgroundImage': 'url(images/2.svg)'};
const style3 = {'backgroundImage': 'url(images/3.svg)'};
const style4 = {'backgroundImage': 'url(images/4.svg)'};
...
/* const App = (
        ...
        <header>
            <div class="wrapper">
                <div class="header">
                    ...
                    <a href="tel:888" class="header-phone"></a>
                    <div class="header-phonelink"><a href="tel:7(962)556-1234">+7(962)556-1234</a></div>
                </div>
            </div>
	    </header>
	    ...
	    <section class="contact">
		    <div class="wrapper">
			    <div class="contact-wrapper">
				    ...
				    <form action="../mailer.smart.php" class="contact-form"><input type="text" placeholder="Ваше имя" />
					    <input type="tel" placeholder="Телефон" /> <input type="email" placeholder="E-mail" />
        ...
        <footer>
            <div class="footer">
                ...
                <div class="footer-websurfer"><span class="footer-websurfer_build">Сделано</span> <a href="#"
                        >Ваше имя</a></div>
